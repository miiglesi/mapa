...
$(function() {
    ...
    if (globalConfig.elements.$shareButtons.length) {
        globalConfig.elements.$shareButtons.on("click", function(e) {
            ...
            if ($this.data("url").length > 4 && !$this.hasClass("js-share-img")) {
...
var utils = function() {
    ...
    function initializeClock($clock) {
        var clock;
        var clockHTML = `<span class="js-cnt-days"><span class="minutes js-days-left"></span>days</span>\n                       <span class="js-cnt-hours"><span class="seconds js-hours-left"></span>hours</span>\n                       <span class="js-cnt-mins"><span class="minutes js-mins-left"></span>mins</span>\n                       <span class="js-cnt-secs"><span class="seconds js-secs-left"></span>secs</span>`;
        var time = {
        ...
        clock = {
            ...
            labelExpired: $clock.attr("data-label-expired") || "Time expired"
        };
    ...
    var changeInputValidation = function(inputs, isRequired, options) {
        if (inputs) {
            var $inputs = $(inputs);
    ...
    function loadGoogleMapScript() {
        var deferred = $.Deferred();
        $.getScript(Globals.srcGooglemapsKey).done(() => {
            deferred.resolve();
        }).fail(() => {
            deferred.reject();
        });
